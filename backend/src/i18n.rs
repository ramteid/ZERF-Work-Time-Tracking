...
static LANGUAGES: &[LangDef] = &[
    LangDef {
        ...
        translations: &[
            ...
            ("pdf_payroll_late_entries_heading", "Booked later - days from earlier months"),
            ...
            ("pdf_payroll_late_entries_note", "These working days were recorded only after the report for their own month had already been sent. They are listed under the day they were worked, so please book them into that month."),
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("pdf_payroll_late_entries_heading", "Nachtr\u{00e4}glich erfasst - Tage aus fr\u{00fc}heren Monaten"),
            ...
            ("pdf_payroll_late_entries_note", "Diese Arbeitstage wurden erst erfasst, nachdem die Meldung f\u{00fc}r ihren eigenen Monat schon verschickt war. Sie stehen hier mit dem Tag, an dem gearbeitet wurde - bitte diesem Monat zuordnen."),

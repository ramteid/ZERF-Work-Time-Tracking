...
static LANGUAGES: &[LangDef] = &[
    LangDef {
        ...
        translations: &[
            ...
            ("month_end_submission_reminder_title", "{month} is not handed in yet"),
            ("month_end_submission_reminder_body", "You still have days in {month} that you have not submitted. The monthly reports can only be finalized once they are in.\n\nA week can be submitted as soon as you know you will not book anything else in it \u{2014} including a week that reaches into the new month."),
            ("month_end_submission_reminder_email_body", "Hello,\n\nyou still have days in {month} that have not been submitted. The monthly reports can only be finalized once they are in.\n\nA week can be submitted as soon as you know you will not book anything else in it \u{2014} including a week that reaches into the new month.\n\nPlease open the application and submit those days."),
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("month_end_submission_reminder_title", "{month} ist noch nicht eingereicht"),
            ("month_end_submission_reminder_body", "Sie haben im {month} noch Tage, die Sie nicht eingereicht haben. Die Monatsauswertungen k\u{00f6}nnen erst abgeschlossen werden, wenn sie eingereicht sind.\n\nEine Woche k\u{00f6}nnen Sie einreichen, sobald Sie wissen, dass Sie darin nichts mehr buchen \u{2014} auch eine Woche, die in den neuen Monat hineinreicht."),
            ("month_end_submission_reminder_email_body", "Hallo,\n\nSie haben im {month} noch Tage, die nicht eingereicht wurden. Die Monatsauswertungen k\u{00f6}nnen erst abgeschlossen werden, wenn sie eingereicht sind.\n\nEine Woche k\u{00f6}nnen Sie einreichen, sobald Sie wissen, dass Sie darin nichts mehr buchen \u{2014} auch eine Woche, die in den neuen Monat hineinreicht.\n\nBitte \u{00f6}ffnen Sie die Anwendung und reichen Sie diese Tage ein."),

...
static LANGUAGES: &[LangDef] = &[
    LangDef {
        ...
        translations: &[
            ...
            ("month_weeks_reminder_title", "Weeks of {month} are still missing"),
            ("month_weeks_reminder_body", "These weeks of {month} have not been handed in yet: {weeks}\n\nPlease submit them by {deadline}."),
            ("month_weeks_reminder_email_body", "Hello,\n\nthe following weeks of {month} have not been handed in yet:\n\n{weeks}\n\nPlease open the application and submit them by {deadline}."),
            ("month_end_submission_reminder_title", "Hand in {month} by {deadline}"),
            ("month_end_submission_reminder_body", "Please submit every hour you worked in {month} by {deadline}. Days from the week that runs across the turn of the month count too \u{2014} you can hand a week in as soon as you know you will not book anything else in it."),
            ("month_end_submission_reminder_email_body", "Hello,\n\nplease submit every hour you worked in {month} by {deadline}.\n\nThis includes days from the week that runs across the turn of the month \u{2014} you can hand a week in as soon as you know you will not book anything else in it.\n\nPlease open the application and submit them."),
            ("month_end_approval_reminder_title", "{month} is waiting for your approval"),
            ("month_end_approval_reminder_body", "{count} of the people you approve have handed in days in {month} that are still waiting for a decision. The monthly reports go out once they are approved."),
            ("month_end_approval_reminder_email_body", "Hello,\n\n{count} of the people you approve have handed in days in {month} that are still waiting for a decision. The monthly reports go out once they are approved.\n\nPlease open the application and review them."),
            ("payroll_report_blocked_title", "Payroll report for {month} is on hold"),
            ("payroll_report_blocked_body", "The report could not be sent on the scheduled day because {count} of {total} people have not finished {month} yet: {names}. It will be sent automatically as soon as they have."),
            ("payroll_report_blocked_email_body", "Hello,\n\nthe payroll report for {month} could not be sent on the scheduled day. {count} of {total} covered people have not finished the month yet:\n\n{names}\n\nThe report will be sent automatically as soon as everybody's month is final."),
            ...
            ("pdf_flextime_adjustments", "Flextime adjustments"),
            ...
            ("pdf_payroll_snapshot_heading", "Interim status - the month is still running"),
            ("pdf_payroll_snapshot_summary", "This report shows the approved figures for {included} people up to the date it was sent. The month is not over, so the figures will still change."),
            ...
            ("pdf_payroll_late_entries_heading", "Corrections - days from earlier months"),
            ("pdf_payroll_late_absences_heading", "Reported later - absences from earlier months"),
            ("pdf_payroll_late_absences_note", "These absences were recorded only after the report for their own month had already been sent. They are listed with the dates they actually cover, so please book them into those months."),
            ("pdf_payroll_late_entries_note", "These values correct working time for months whose report was already sent. Positive hours add time and negative hours reduce it. Each correction is listed under the affected workday, so please adjust that month."),
            ...
            ("pdf_payroll_column_medical_certificate", "eAU"),
            ("pdf_payroll_medical_certificate_yes", "Yes"),
            ("pdf_payroll_medical_certificate_no", "No"),
    ...
    LangDef {
        ...
        translations: &[
            ...
            ("month_weeks_reminder_title", "Es fehlen noch Wochen aus {month}"),
            ("month_weeks_reminder_body", "Diese Wochen aus {month} sind noch nicht eingereicht: {weeks}\n\nBitte reichen Sie sie bis zum {deadline} ein."),
            ("month_weeks_reminder_email_body", "Hallo,\n\ndie folgenden Wochen aus {month} sind noch nicht eingereicht:\n\n{weeks}\n\nBitte \u{00f6}ffnen Sie die Anwendung und reichen Sie sie bis zum {deadline} ein."),
            ("month_end_submission_reminder_title", "{month} bis zum {deadline} einreichen"),
            ("month_end_submission_reminder_body", "Bitte reichen Sie alle im {month} gearbeiteten Stunden bis zum {deadline} ein. Dazu z\u{00e4}hlen auch Tage aus der Woche, die \u{00fc}ber den Monatswechsel l\u{00e4}uft \u{2014} eine Woche k\u{00f6}nnen Sie einreichen, sobald Sie wissen, dass Sie darin nichts mehr buchen."),
            ("month_end_submission_reminder_email_body", "Hallo,\n\nbitte reichen Sie alle im {month} gearbeiteten Stunden bis zum {deadline} ein.\n\nDazu z\u{00e4}hlen auch Tage aus der Woche, die \u{00fc}ber den Monatswechsel l\u{00e4}uft \u{2014} eine Woche k\u{00f6}nnen Sie einreichen, sobald Sie wissen, dass Sie darin nichts mehr buchen.\n\nBitte \u{00f6}ffnen Sie die Anwendung und reichen Sie sie ein."),
            ("month_end_approval_reminder_title", "{month} wartet auf Ihre Genehmigung"),
            ("month_end_approval_reminder_body", "{count} der von Ihnen genehmigten Personen haben Tage im {month} eingereicht, \u{00fc}ber die noch nicht entschieden wurde. Die Monatsauswertungen gehen raus, sobald sie genehmigt sind."),
            ("month_end_approval_reminder_email_body", "Hallo,\n\n{count} der von Ihnen genehmigten Personen haben Tage im {month} eingereicht, \u{00fc}ber die noch nicht entschieden wurde. Die Monatsauswertungen gehen raus, sobald sie genehmigt sind.\n\nBitte \u{00f6}ffnen Sie die Anwendung und pr\u{00fc}fen Sie sie."),
            ("payroll_report_blocked_title", "Lohnmeldung f\u{00fc}r {month} wartet noch"),
            ("payroll_report_blocked_body", "Die Meldung konnte am geplanten Tag nicht versendet werden, weil {count} von {total} Personen den {month} noch nicht abgeschlossen haben: {names}. Sie wird automatisch versendet, sobald das erledigt ist."),
            ("payroll_report_blocked_email_body", "Hallo,\n\ndie Lohnmeldung f\u{00fc}r {month} konnte am geplanten Tag nicht versendet werden. {count} von {total} erfassten Personen haben den Monat noch nicht abgeschlossen:\n\n{names}\n\nDie Meldung wird automatisch versendet, sobald bei allen der Monat abgeschlossen ist."),
            ...
            ("pdf_flextime_adjustments", "Gleitzeitkorrekturen"),
            ...
            ("pdf_payroll_snapshot_heading", "Zwischenstand - der Monat l\u{00e4}uft noch"),
            ("pdf_payroll_snapshot_summary", "Diese Meldung zeigt die genehmigten Zahlen von {included} Personen bis zum Versandtag. Der Monat ist noch nicht zu Ende, die Zahlen \u{00e4}ndern sich also noch."),
            ...
            ("pdf_payroll_late_entries_heading", "Korrekturen - Tage aus fr\u{00fc}heren Monaten"),
            ("pdf_payroll_late_absences_heading", "Nachtr\u{00e4}glich gemeldet - Abwesenheiten aus fr\u{00fc}heren Monaten"),
            ("pdf_payroll_late_absences_note", "Diese Abwesenheiten wurden erst erfasst, nachdem die Meldung f\u{00fc}r ihren eigenen Monat schon verschickt war. Sie stehen hier mit den Tagen, die sie tats\u{00e4}chlich betreffen - bitte diesen Monaten zuordnen."),
            ("pdf_payroll_late_entries_note", "Diese Werte korrigieren Arbeitszeit in Monaten, deren Meldung bereits versendet wurde. Positive Stunden erh\u{00f6}hen die gemeldete Zeit, negative Stunden mindern sie. Jede Korrektur steht beim betroffenen Arbeitstag - bitte den jeweiligen Monat entsprechend anpassen."),
            ...
            ("pdf_payroll_column_medical_certificate", "eAU"),
            ("pdf_payroll_medical_certificate_yes", "Ja"),
            ("pdf_payroll_medical_certificate_no", "Nein"),
    ...
    fn every_notification_event_has_app_and_email_templates() {
        for language in LANGUAGES {
            ...
            let params = [
                ...
                ("count", "2".to_string()),
                ("total", "5".to_string()),
                ("month", "Example Month 2030".to_string()),
                ("deadline", "04/09/2030".to_string()),
                ("names", "Example User, Another User".to_string()),
